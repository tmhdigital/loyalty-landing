    ...
    <section id="for-business" className="py-24 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-line p-9 lg:p-10 hover:shadow-card transition-shadow">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-secondary p-9 lg:p-10 hover:shadow-card transition-shadow">
